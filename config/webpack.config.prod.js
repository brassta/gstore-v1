      ...
      functions: {
        '__encode64($s)': $s =>
          nodeSass.types.String(
            Buffer.from($s.getValue()).toString('base64'),
          ),
        '__decode64($s)': $s =>
          nodeSass.types.String(
            Buffer.from($s.getValue(), 'base64').toString('utf8'),
          ),
      },
    },
  },
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(Object.assign(htmlWebpackPluginOptions, {
      ...
      excludeAssets: [/\/static\/js\/static.*.js/, /\/static\/css\/static.*.css/],
    })),
    new HtmlWebpackPlugin({
      filename: 'restricted.html',
      template: paths.restrictedHtml,
      excludeAssets: [/\/static\/js\/main.*.js/, /\/static\/css\/main.*.css/],
    }),
    new HtmlWebpackPlugin(Object.assign(htmlWebpackPluginOptions, {
